					...
					<div class="col-sm-2">
						<div class="logo">
							<a href="index.html"> <img src="img/logo.png" alt="logo"
								width="30" height="30"> LASER Airlines
							</a>
						...
						<div class="main-menu">
							...
							<div class="collapse navbar-collapse">
								<ul class="nav navbar-nav navbar-right">
									...
									<li class="smooth-menu"><a href="#">Turista</a></li>
									<li class="smooth-menu"><a href="#">turista VIP </a></li>
									<li class="smooth-menu"><a href="#">Ofertas
											especiales</a></li>
									<li class="smooth-menu"><a href="#subs">suscripcion</a></li>
									<li class="smooth-menu"> <form action="/logout" method="post" class="w3-right ">
						...
						<div class="single-about-us">
							<div class="about-us-txt">
								...
								<div class="about-btn">
									...
									<form action="/servicioTur" method="get">
										<button type="submit" class="btn btn-success">
											Usertur</button>
									</form>

									<form action="/servicioPre" method="get">
										<button type="submit" class="btn btn-success">
											Userpre</button>
									</form>
								</div>
					...
					<div class="col-sm-3">
						<div class="single-footer-item">
							<div class="footer-logo">
								...
								<p>La mejor agencia de vuelos</p>
							</div>
						</div>
						<!--/.single-footer-item-->
					</div>
					...
					<div class="col-sm-3">
						<div class="single-footer-item">
							...
							<div class="single-footer-txt">
								<p>
									<a href="volver">home</a>
								</p>
								<p>
									<a href="volver">destinos</a>
								</p>
								<p>
									<a href="volver">paquetes VIP</a>
								</p>
								<p>
									<a href="volver">ofertas especiales</a>
								</p>

								<p>
									<a href="volver">contacto</a>
								</p>
							</div>
							<!--/.single-footer-txt-->
						</div>
